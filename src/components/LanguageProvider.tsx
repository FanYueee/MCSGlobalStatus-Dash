...
const translations = {
    en: {
        ...
        mobile_switch_standard: "Switch to Standard",
        mobile_switch_distributed: "Switch to Distributed",
    ...
    'zh-TW': {
        ...
        nav_faq: "常見問題",
        mobile_menu_open: "選單",
        mobile_menu_close: "關閉",
        mobile_switch_standard: "切換到標準模式",
        mobile_switch_distributed: "切換到分佈式",
